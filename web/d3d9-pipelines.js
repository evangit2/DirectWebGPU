...
export class PipelineCache{
 ...
 async get(vertex,pixel,declaration,streams,state,{colorFormat='bgra8unorm',depthFormat='depth24plus-stencil8',topology='triangle-list',fixed=false,textured=false,viewportSize=null}={}){
  ...
  const vertexSource=viewportSize?translator.vertexPosition(expanded,...viewportSize):expanded;
