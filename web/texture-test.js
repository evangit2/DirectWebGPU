...
export async function testTextures(device){
 ...
 try{
  ...
  return {result:'passed',compressed,checks:['GPU readback verifies pitched BGRA rows','XRGB samples opaque without modifying guest','compressed mip payloads including 2x2 and 1x1 copied exactly','invalid ranges and stale handles rejected','resource budget released'],HumusFrames:0};
