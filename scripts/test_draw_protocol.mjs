...
const color={createView(){return'color-view'}},depth={createView(){return'depth-view'}};renderer.backend={color,depth,width:800,height:600,targetColor:{texture:color,view:'color-view',width:800,height:600,format:'bgra8unorm',textureId:0,stencil:false},targetDepth:{texture:depth,view:'depth-view',width:800,height:600,format:'depth24plus-stencil8',textureId:0,stencil:true}};renderer.clear(7,{r:0,g:0,b:0,a:1},1,0);renderer.present('swap-texture');
