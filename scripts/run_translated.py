...
env=dict(os.environ,THESEUS_HEADLESS='1',THESEUS_TRACE='kernel32,user32,advapi32,d3d9',THESEUS_MISSING_ADDRS=str(root/'evidence/missing-addresses.txt'),RUST_BACKTRACE='1')
