...
const touchInverted={...inverted,touchJoystick:{cursorVisible:{horizontalSign:-1,verticalSign:-1},cursorHidden:{horizontalSign:-1,verticalSign:-1}}};
...
assert.equal(directionalCode('ArrowUp',touchInverted,true,'touchJoystick'),'ArrowDown');
assert.equal(directionalCode('ArrowLeft',touchInverted,false,'touchJoystick'),'ArrowRight');
