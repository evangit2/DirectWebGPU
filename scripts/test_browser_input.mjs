...
const recentered={keyboard:{cursorHidden:{horizontalSign:-1,verticalSign:-1}},touchJoystick:{cursorHidden:{horizontalSign:-1,verticalSign:-1},relativePointer:{horizontalSign:-1,verticalSign:-1}}};
...
assert.equal(directionalCode('ArrowUp',recentered,true,'keyboard',true),'ArrowUp');
...
documentListeners.get('keydown')({type:'keydown',code:'ArrowUp',repeat:false,preventDefault(){}});
assert.deepEqual(recenteredSent.at(-1),[5,0x48,0x26,1]);
documentListeners.get('keyup')({type:'keyup',code:'ArrowUp',repeat:false,preventDefault(){}});
