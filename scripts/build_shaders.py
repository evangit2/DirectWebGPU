...
for name in ['vertex','pixel','texture','vertexConstant']:(out/(name+'.bin')).write_bytes(struct.pack('<'+'I'*len(f[name]),*f[name]))

import hashlib,datetime
artifacts=['mojoshader.js','mojoshader.wasm','shader_translation.js','shader_translation_bg.wasm','vertex.bin','pixel.bin','texture.bin','vertexConstant.bin']
