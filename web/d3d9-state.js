...
export class D3D9RenderState{
 ...
 set(type,value){
  ...
  const choices=({7:[0,1],14:[0,1],15:[0,1],27:[0,1],52:[0,1],136:[0,1],174:[0,1],22:[1,2,3]})[type];
